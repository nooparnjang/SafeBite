...
const Navbar: React.FC = () => (
    <nav className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-start items-center space-x-6 text-gray-700">
           ...
           <Link href={"warmDog"} className="bg-gray-800 text-white px-4 py-2 rounded-lg font-bold">รายงานสุนัขจรจัด</Link>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-gray-700 font-semibold">
                  รายงานสุนัขจรจัด <span className="text-red-500">*</span>
                </label>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-10 text-center cursor-pointer hover:border-gray-500 transition duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-8 w-8 text-gray-400 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.863-1.437A2 2 0 0110.424 4h3.152a2 2 0 011.664.89l.863 1.437A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  <p className="text-gray-500 text-sm">อัปโหลดรูปภาพของสุนัขที่หายไป</p>
